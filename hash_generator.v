module hash_generator(clk , rst , start , msg , done_rnd , start_rnd, hash , done);
    ...
    hash_generator_controller c1(clk , rst , start , co , done_rnd , start_rnd , en ,  sa , sb , sc , sd,sf,loada, loadb , loadc, loadd,loadf,s1 , done);
