module hash_generator #(parameter WORD_WIDTH = 32)(clk , rst , start , message,a0,b0,c0,d0 , done_rnd , s1 , start_rnd , out_counter , hash , done);
    ...
    hash_generator_dp #(WORD_WIDTH) d1(message,a0 , b0 , c0 , d0,constant,clk,rst, en ,  sa , sb , sc , sd,sf,loada, loadb , loadc, loadd,loadf,loadm,s1, hash, out_counter, co);
