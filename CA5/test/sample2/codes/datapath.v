...
always @(*) begin
  case (alu1_sel2)
    4'd0: alu1_in2 = i2;
    4'd1: alu1_in2 = i3;
    4'd2: alu1_in2 = reg_10;
    4'd3: alu1_in2 = reg_11;
    default: alu1_in2 = 0;
  endcase
end
always @(*) begin
...
always @(posedge clk or posedge rst) begin
  if (rst) begin
    ...
    if (reg_10_en) reg_10 <= alu3_out;
    if (reg_11_en) reg_11 <= alu1_out;
    if (reg_12_en) reg_12 <= alu1_out;
    if (reg_2_en) reg_2 <= alu1_out;
    if (reg_4_en) reg_4 <= alu1_out;
    if (reg_5_en) reg_5 <= log1_out;
    if (reg_6_en) reg_6 <= alu2_out;
    if (reg_7_en) reg_7 <= mul1_out;
    if (reg_8_en) reg_8 <= mul1_out;
    if (reg_9_en) reg_9 <= log2_out;
