module hash_generator #(parameter WORD_WIDTH =8)(clk , rst , start , message,a0,b0,c0,d0 , done_rnd , s1 , start_rnd , out_counter , hash , done);
    ...
    wire en ,  sa , sb , sc , sd , sf , loada , loadb , loadc, loadd , loadf,loadm , co , clear , rst_or_clr;
    wire [WORD_WIDTH-1:0] constant;
   
    or_c1 or_ins (clear, rst, rst_or_clr);
    hash_generator_dp #(WORD_WIDTH) d1(message,a0 , b0 , c0 , d0,constant,clk,rst_or_clr, en ,  sa , sb , sc , sd,sf,loada, loadb , loadc, loadd,loadf,loadm,s1, hash, out_counter, co);

    hash_generator_controller c1(clk , rst , start , co , done_rnd , start_rnd , en ,  sa , sb , sc , sd,sf,loada, loadb , loadc, loadd,loadf,loadm , done , clear);
