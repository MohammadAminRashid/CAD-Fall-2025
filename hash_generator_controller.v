module hash_generator_controller(clk , rst , start , co , done_rnd , start_rnd , en ,  sa , sb , sc , sd,sf,loada, loadb , loadc, loadd,loadf,s1 , done);
input clk , rst , start , co , done_rnd;
output reg start_rnd , en ,  sa , sb , sc , sd,sf,loada, loadb , loadc, loadd,loadf,s1 , done;
...
always@(ps , start , co , done_rnd) 
    ...
    always@(ps)
    begin
        en = 0 ; sa = 0 ; sb = 0 ; sc = 0 ; sd = 0; sf = 0; loada = 0; loadb = 0; loadc = 0;  loadd = 0; loadf = 0; s1 = 0; done = 0 ;
        case(ps) 
