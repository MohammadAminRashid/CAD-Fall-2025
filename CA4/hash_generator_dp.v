module hash_generator_dp #(parameter WORD_WIDTH = 32)(
    ...
    wire [WORD_WIDTH-1:0] mux4to1_out, multiplier_out;
    ...
    adder #(WORD_WIDTH) adder1(multiplier_out, B, adder_out_1);
    ...
    multiplier #(WORD_WIDTH/2) mul (F[WORD_WIDTH-1:WORD_WIDTH/2], F[WORD_WIDTH/2-1:0], multiplier_out);
